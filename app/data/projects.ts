...
export const projects: Record<string, Project> = {
  ...
  "cheongna-prugio": {
    ...
    seo: {
      ...
      description:
        "인천 청라 푸르지오 전용 139.48㎡, 공급 187.38㎡의 인테리어 디자인 제안입니다. 우드와 루버, 간접조명, 대면형 아일랜드와 조적 욕조를 중심으로 재팬디 주거 공간을 계획했습니다.",
    },
    category: "Residential Interior",
    projectGroup: "Residential",
    type: "Apartment Renovation",
    year: "2026",
    area: "전용 139.48㎡ · 공급 187.38㎡",
    images: 21,
    heroImage: "/projects/cheongna-prugio/01-hero-living-room-night.webp",
    thumbnailImage: "/projects/cheongna-prugio/01-hero-living-room-night.webp",
    heroAspectRatio: "1870 / 841",
    location: "인천 청라",
    designScope: "전체 인테리어 디자인",
    overview:
      "인천 청라 푸르지오를 위한 재팬디 스타일의 인테리어 디자인 제안입니다. 우드와 루버의 반복, 벽을 따라 번지는 간접광을 바탕으로 공용 공간과 개인 공간의 흐름을 정리했습니다. 대면형 아일랜드와 분리된 건식세면대, 조적 욕조, 확장된 드레스룸으로 생활의 기능을 구체화했습니다.",
    gallery: [
      "/projects/cheongna-prugio/01-hero-living-room-night.webp",
      "/projects/cheongna-prugio/02-entry-front.webp",
      "/projects/cheongna-prugio/03-entry-side.webp",
      "/projects/cheongna-prugio/04-entry-pantry-closed.webp",
      "/projects/cheongna-prugio/05-entry-pantry-open.webp",
      "/projects/cheongna-prugio/06-corridor.webp",
      "/projects/cheongna-prugio/07-corridor-hidden-doors.webp",
      "/projects/cheongna-prugio/08-living-room-front-day.webp",
      "/projects/cheongna-prugio/09-living-room-angle-day.webp",
      "/projects/cheongna-prugio/10-living-room-angle-night.webp",
      "/projects/cheongna-prugio/11-kitchen-angle.webp",
      "/projects/cheongna-prugio/12-kitchen-side.webp",
      "/projects/cheongna-prugio/13-secondary-kitchen.webp",
      "/projects/cheongna-prugio/14-common-dry-vanity.webp",
      "/projects/cheongna-prugio/15-common-bathroom.webp",
      "/projects/cheongna-prugio/16-master-bedroom-day.webp",
      "/projects/cheongna-prugio/17-master-bedroom-night.webp",
      "/projects/cheongna-prugio/18-master-dressing-room.webp",
      "/projects/cheongna-prugio/19-master-dry-vanity.webp",
      "/projects/cheongna-prugio/20-master-bathroom.webp",
      "/projects/cheongna-prugio/21-small-bedroom-loft-bed.webp",
    ],
    beforeImages: [],
    featured: true,
    featuredOrder: 4,
