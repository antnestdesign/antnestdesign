...
export default function ApartmentA({ project }: { project: Project }) {
    ...
    <>
      <section className="max-w-4xl mx-auto px-8 md:px-16 mb-28 md:mb-36">
        <div className="space-y-6">
          {[
            "수원 영통 살구골 현대7단지 전용 99.58㎡·36평형 아파트로, 부부와 초등학생 자녀의 수납과 생활 동선을 다시 정리하는 데 중점을 둔 인테리어 프로젝트입니다.",
            ...
            <div className="border-t border-neutral-300 pt-8 md:pt-10">
              ...
              <div className="grid md:grid-cols-12 gap-8 md:gap-12 items-center">
                <div className="md:col-span-5">
                  ...
                  <p className="text-[13px] md:text-base leading-7 md:leading-8 text-neutral-600 break-keep">
                    냉장고를 주방 안에 두지 않고 주방 발코니 쪽으로 이동해,
                    본 주방에는 더 넓은 수납과 조리 공간을 확보했습니다.
                    기능은 뒤로 정리하고, 가족이 함께 사용하는 주방은 더 넓고
                    단정하게 사용할 수 있도록 계획했습니다.
                  </p>
                </div>
