    ...
    <>
      ...
      <section className="mb-28 md:mb-40">
        <SectionHeading
          ...
          title="장으로 확장한 드레스룸"
          description="이 제안의 핵심은 안방 일부를 장으로 분할해 드레스룸 공간을 기존보다 넓게 사용할 수 있도록 계획한 점입니다. 수납장이 단순히 벽면에 붙는 것이 아니라 공간을 나누는 장치로 작동하도록 구성해, 가족의 생활 물건이 밖으로 드러나지 않는 구조를 만들었습니다."
        />
      ...
      <section className="mb-28 md:mb-40">
        <SectionHeading
          eyebrow="Vanity"
          title="정돈된 사용성을 가진 세면 공간"
          description="세면 공간은 밝은 석재 질감의 마감과 간접조명을 중심으로 정돈된 분위기를 만들었습니다. 거울과 하부장의 선을 단정하게 맞추고, 수납과 사용 동선을 함께 고려해 작은 공간에서도 깊이감과 안정감이 느껴지도록 계획했습니다."
        />

        <div className="max-w-6xl mx-auto px-8 md:px-16">
          <ProjectImage
            src={images.vanity}
            alt="청라 호반4차 33A 세면 공간 렌더링"
            ratio="aspect-[16/9]"
            quality={82}
          />
        </div>
